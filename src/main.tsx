...
const DICTIONARIES: Record<Locale, Record<string, string>> = {
    en: {
        ...
        'data.placeholder.add': 'New record...',
        'data.placeholder.search': 'Search records...',
        'data.add': 'Add',
        'data.find': 'Find',
        'data.reload': 'Reload',
        'data.mode.search': 'Search mode',
        'data.mode.add': 'Add mode',
        'data.col.index': '#',
        'data.col.text': 'Text',
    ...
    ru: {
        ...
        'google.setup.step1.title': '1. Создайте проект',
        'google.setup.step1.text': 'console.cloud.google.com.',
        'google.setup.step2.title': '2. Включите Google Sheets API',
        'google.setup.step2.text': 'Найдите и включите.',
        'google.setup.step2.fallback': 'При ошибке:',
        'google.setup.step3.title': '3. OAuth и тестовые пользователи',
        'google.setup.step3.text': 'Audience → External.',
        'google.setup.step3.critical': 'Критично:',
        'google.setup.step3.critical.text': 'Добавьте email в Test users.',
        'google.setup.step4.title': '4. Scopes',
        'google.setup.step4.text': 'Data Access → Add scopes.',
        'google.setup.step4.manual': 'Вручную:',
        'google.setup.step4.save': 'Update, Save.',
        'google.setup.step5.title': '5. OAuth Client ID',
        'google.setup.step5.text': 'Clients → Create → Web.',
        'google.setup.step5.origins': 'Origins:',
        'google.setup.step5.origins.dev': 'для Parcel',
        'google.setup.step5.origins.prod': 'для GitHub Pages',
        'google.setup.step6.title': '6. Подключите',
        'google.setup.step6.text': 'Вставьте Client ID.',
        'google.setup.step6.spreadsheet': 'Spreadsheet ID + вкладка.',
        'google.setup.step6.reconnect': 'Disconnect → Reconnect.',
        'google.setup.step6.checkbox': 'Отметьте доступ к Sheets.',
        'google.security.title': '🔒 Безопасность',
        'google.security.1': 'Client ID публичный.',
        'google.security.2': 'Не вводите Secret.',
        'google.security.3': 'Токен в памяти.',
        'google.security.4': 'Свой аккаунт.',
        'google.clientId': 'OAuth Client ID',
        'google.clientId.placeholder': '123...apps.googleusercontent.com',
        'google.clientId.hint': 'Публичный ID.',
        'google.spreadsheetId': 'Spreadsheet ID или URL',
        'google.spreadsheetId.placeholder': 'https://docs.google.com/spreadsheets/d/...',
        'google.sheetName': 'Имя вкладки',
        'google.connectedDoc': 'Документ',
        'google.headers.info': 'Заголовки:',
        ...
        'google.btn.createSheet': 'Создать',
        'google.btn.switchToGoogle': 'Google Sheets',
        'google.btn.switchToLocal': 'localStorage',
        'google.newSheetTitle': 'Название',
        'google.newSheetTitle.placeholder': 'Хранилище',
        'google.error.noClientId': 'Введите Client ID.',
        'google.error.noSpreadsheet': 'Введите Spreadsheet ID.',
        'google.msg.connected': 'Подключён.',
        'google.msg.disconnected': 'Отключён. localStorage.',
        ...
        'toast.silentAuthFailed': 'Автовход не удался. Переподключитесь.',
        'toast.details': 'Подробности',
        'data.placeholder.add': 'Новая запись...',
        'data.placeholder.search': 'Поиск записей...',
        'data.add': 'Добавить',
        'data.find': 'Найти',
        'data.reload': 'Обновить',
        'data.mode.search': 'Режим поиска',
        'data.mode.add': 'Режим добавления',
        'data.col.index': '#',
        'data.col.text': 'Текст',
        'data.col.created': 'Создано',
        'data.col.actions': '',
        'data.empty': 'Пока пусто.',
        ...
        <div
            ...
            <main className="mx-auto max-w-6xl px-4 py-6">
                ...
                <div className="mb-4 flex items-center gap-2">
                    ...
                    <span
                        className="text-xs text-slate-500 dark:text-slate-400">{plur(records.length, t)}{searchQuery && ` · ${filteredRecords.length} found`}</span>
                </div>
                    ...
                    <div key={inputMode} className="flex gap-2 animate-fade-in">
                        ...
                        {inputMode === 'add' ? (
                            ...
                            <button type="button" disabled
                                    className="inline-flex items-center gap-1.5 rounded-xl bg-slate-900 dark:bg-slate-100 px-4 py-2.5 text-sm font-medium text-white dark:text-slate-900 opacity-80 cursor-default">
                ...
                {hasMore && <div className="mt-4 flex justify-center">
                    <button type="button" onClick={() => setVisiblePages(p => p + 1)}
                            className="inline-flex items-center gap-2 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-6 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-slate-700">{t('data.loadMore')} ({filteredRecords.length - visibleCount})
                    </button>
                </div>}
                {DEBUG && <details
